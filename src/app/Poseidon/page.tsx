        ...
        <div className="min-h-screen bg-[#000000] text-white flex items-center justify-center p-6">
            <div className="max-w-4xl p-8 bg-gradient-to-b from-blue-900 to-gray-800 rounded-lg shadow-lg">
                ...
                <div className="space-y-10">
                    <section className="relative">
                        ...
                        <div className="relative p-6 bg-black bg-opacity-50 rounded-md shadow-md">
                            <h2 className="text-3xl font-semibold mb-4 flex items-center">
                                <i className="fas fa-cloud-showers-heavy mr-2"></i>
                    ...
                    <section className="relative">
                        {/* <img src="/images/cliff.jpg" alt="Cliff" className="absolute inset-0 w-full h-full object-cover opacity-20" /> */}
                        <div className="relative p-6 bg-black bg-opacity-50 rounded-md shadow-md">
                            <h2 className="text-3xl font-semibold mb-4 flex items-center">
                    ...
                    <section className="relative">
                        <img src="/image/kraken.png" alt="Kraken" className="absolute inset-0 w-full h-full object-cover opacity-20" />
                        <div className="relative p-6 bg-black bg-opacity-50 rounded-md shadow-md">
                            <h2 className="text-3xl font-semibold mb-4 flex items-center">
                    ...
                    <section className="relative">
                        <img src="/images/hero.jpg" alt="Hero" className="absolute inset-0 w-full h-full object-cover opacity-20" />
                        <div className="relative p-6 bg-black bg-opacity-50 rounded-md shadow-md">
                            <h2 className="text-3xl font-semibold mb-4 flex items-center">
                    ...
                    <section className="relative">
                        <img src="/images/titans.jpg" alt="Titans" className="absolute inset-0 w-full h-full object-cover opacity-20" />
                        <div className="relative p-6 bg-black bg-opacity-50 rounded-md shadow-md">
                            <h2 className="text-3xl font-semibold mb-4 flex items-center">
                                <i className="fas fa-hammer mr-2"></i>
                                Chapter Five: The Clash of Titans
                            </h2>
                            <p className="text-lg">
                                The sea churned as Poseidon, his fury a tangible force, confronted Circe. “Your treachery ends here, witch!” he roared, his trident crackling with divine energy. Circe, her eyes glowing with malevolent power, laughed. “You cannot stop me, Sea King. My power is beyond your comprehension.”
                            </p>
                            <p className="mt-4 text-lg">
                                Proteus, his battle with the Kraken reaching a fever pitch, felt the ground tremble beneath his feet. The clash of titans was upon them. He knew that the outcome of this battle would determine the fate of the world.
                            </p>
                            <p className="mt-4 text-lg">
                                On the ship, Orion and his crew watched in awe and terror. The sky was a maelstrom of lightning and thunder, the sea a battlefield of unimaginable power. Lysander, his heart pounding, stood beside his captain. “We must hold on, Captain. We must have faith.”
                            </p>
                            <p className="mt-4 text-lg">
                                The clash of titans was a sight to behold. Poseidon and Circe, locked in a battle of wills, fought with a ferocity that shook the heavens. The Kraken, its tentacles flailing, sought to crush Proteus. The fate of the world hung in the balance.
                            </p>
                        </div>
                    </section>

                    <section className="relative">
                        <img src="/images/ship.jpg" alt="Ship" className="absolute inset-0 w-full h-full object-cover opacity-20" />
                        <div className="relative p-6 bg-black bg-opacity-50 rounded-md shadow-md">
                            <h2 className="text-3xl font-semibold mb-4 flex items-center">
                            ...
                            <p className="text-lg">
                                As dawn broke, the storm began to subside. The Kraken, its form shattered and broken, sank back into the abyss. Proteus, battered but victorious, stood as a testament to the indomitable spirit of mankind. Poseidon, his rage spent, returned to his underwater realm. Amphitrite, her heart heavy, followed him. Circe, defeated but not broken, vanished into the shadows, her plans foiled but her spirit unbowed.
                            </p>
                            <p className="mt-4 text-lg">
                                On the ship, Orion and his crew breathed a sigh of relief. Lysander, his eyes filled with a newfound respect for the sea, looked out at the horizon. The storm had passed, but its memory would linger.
                            </p>
                            <p className="mt-4 text-lg">
                                The ocean, a place of mystery and wonder, had once again proven its power. And in its depths, the stories of gods and monsters would continue to echo through eternity.
                            </p>
                        </div>
                    </section>
                </div>
